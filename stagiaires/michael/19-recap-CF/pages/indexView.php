...
<?php
include "include/menuIncView.php";
?>
...
<!--Section header -->
	<section class="header">
		...
		<a href="?page=formations" class="btn">Nos formations</a>
	</section>
	...
	<section class="formations">
		...
		<div class="row">
			...
			<div class="formations-col">
				...
				<a href="?page=formations" class="btn-formation">Découvrir la formation</a>
			</div>
...
<!-- ---------------Section A propos ------------------>
	<section class="apropos">
		<div>
			...
			<a href="?page=formations" class="btn">En savoir Plus</a>
...
<!-- -----------Section devenir formateur --------------->
	<section class="devenir-formateur">
		<div class="text-bloc">
			...
			<a href="?page=formations"><button class="btn-formateur">Devenir Formateur</button></a>
...
<footer>
<?php
include "include/footerIncView.php";
?>
</footer>
